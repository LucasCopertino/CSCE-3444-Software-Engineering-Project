...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates/menu','templates/staff','templates/accounts'], #our update - this setting defines the directory to look for html files to be rendered in the views.py of different apps.
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
